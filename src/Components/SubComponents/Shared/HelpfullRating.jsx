...
const HelpfullRating = (props) => {
  ...
  const liked = () => {
    const res = PostData.LikeCommentPro(props.commentID);
    res.then((value) => {
  ...
  const Unliked = () => {
    const res = PostData.UnLikeCommentPro(props.commentID);
    res.then((value) => {
      console.table("responce", value);
      if (!value.data.success) {
        message.error(value.data.message);
  ...
  const Blockhandle = () => {
    const res = PostData.BlockCommentPro(props.commentID);
    res.then((value) => {
