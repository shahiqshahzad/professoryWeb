...
const Announcement = (props) => {
  return (
    <div className="p-2 mb-3" style={{ border: '1px solid #E0EEFF' }}>
      <div className="card-header mb-1 pb-2 highlight-divs">
        <span className="mb-0 ">
          <p className="mb-0 mt-2 FS-18 Bold mx-3">{props.ClassroomName}</p>
        </span>
      </div>
      <div class="py-2 px-0">
        <div className="row">
        ...
        <p className="text-left FS_14 mb-0 d-block">
          {props.Description}{' '}
