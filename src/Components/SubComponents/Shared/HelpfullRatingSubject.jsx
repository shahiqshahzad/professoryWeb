...
import Share from "../../../Assets/img/reply.svg";
import Like from "../../../Assets/img/like.svg";
import Dislike from "../../../Assets/img/dislike.svg";
import Block from "../../../Assets/img/error.svg";
import checkMark from "../../../Assets/img/Check.svg";
import Avatar from "react-avatar";
import PostData from "../../Api/PostData";
import { message } from "antd";
import CommetSubject from "./ComentSubject";
import $ from "jquery";
import Replies from "./Replies";

const HelpfullRatingSubject = (props) => {
      ...
      <div className="row ShadowBordr Round25 py-3 px-3 px-md-5 my-4 ">
        <div className="col-12 col-sm-4 px-0 mb-3">
          <div className="d-inline-flex w-100 text-center text-md-right">
            ...
            <h5 className="mb-0 mt-2 px-3">{props.commentID}</h5>
          </div>
        </div>
        ...
        <div className="row col-12 mt-3">
          ...
          <div className="col mx-auto px-1 px-sm-3 cursor-pointer">
            <span>
              <img
                onClick={() => liked()}
                src={Like}
        ...
        <div className="row col-12 mt-3 p-0">
          ...
          >
            <CommetSubject id={props.commentID} subjectId={props.ID} />
          </div>
        </div>
...
export default HelpfullRatingSubject;
