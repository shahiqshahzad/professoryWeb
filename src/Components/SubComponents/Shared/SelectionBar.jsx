          ...
          <div className="MaxWidth">
            <div className="row mx-0">
              <div className="row col-11 col-md-10 mx-auto">
                <div className="row col-12 col-lg-6 ml-auto form px-2 my-2">
                ...
                {this.props.buttonValue === "+Add" ? (
                  <div className="row col-12 col-lg-5 mr-auto px-2 px-lg-0">
                    ...
                    <div className="col-12 col-md-4 px-1 pb-3 mt-0">
                      <button
                        className=" button filled_btn widthMaxContent px-3 py-2 mx-2 my-1"
                  ...
                  <div className="row col-12 col-lg-6 mr-auto px-2 px-lg-0">
                    ...
                    <div className="row col-12 col-md-7 mx-0 px-0">
                      <div className="col-12 col-sm-5 col-lg-6 px-1 pb-3 mt-0 mb-3 my-2">
                        <button
                          className=" button filled_btn widthMaxContent px-3 py-2 mr-2"
                          type="button"
                        >
                      ...
                      <div className="col-12 col-sm-6 px-1 pb-3 mt-0 ">
                        <button
                          className=" button widthMaxContent px-3 py-2 mx-lg-3 my-2 "
                          style={{ backgroundColor: "#3679BC", color: "white" }}
                          type="button"
                        >
