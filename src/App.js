        ...
        {this.state.loading ? (
          ...
          <>
            <Navbar
              ...
              LoginStatusChange={this.LoginStatusChange}
            />
            <Switch>
              <Route
                exact
                path="/"
                render={(props) => <Home onChange={this.LoginStatusChange} />}
              />
              ...
              <ProtectedRoute
                exact
                path="/Bookstore/Sale/:BookCategory/:BookId"
                component={BookSale}
              />
              <ProtectedRoute
                exact
                path="/Bookstore/Request/:BookCategory/:BookId"
                component={BookRequest}
              />
              <ProtectedRoute
                exact
                path="/Bookstore/Post"
                component={PostBookAd}
              />
              <ProtectedRoute
                exact
              ...
              <ProtectedRoute
                exact
                path="/ServiceProvider/Sale/:ServiceCategory/:ServiceId"
                component={ServiceSale}
              />
              <ProtectedRoute
                exact
                path="/ServiceProvider/Request/:ServiceCategory/:ServiceId"
                component={ServiceRequest}
              />
              <ProtectedRoute
                exact
                path="/ServiceProvider/Post"
                component={PostServiceAd}
              />
              <ProtectedRoute
                exact
              ...
              <ProtectedRoute
                exact
                path="/ProfessorRating/RateMe/:majorid/:professorID"
                component={ProfessorRateMe}
              />
              <ProtectedRoute
                exact
                path="/ProfessorRating/:ProfessorId"
                component={ProfessorDetails}
              />
              <ProtectedRoute
                exact
                path="/ProfessorRating/Comments/:ProfessorID"
                component={ProfessorAllRatting}
              />
              <ProtectedRoute
                exact
                path="/SubjectRating/Comments/:SubjectID"
                component={SubjectAllRatting}
              />
              <ProtectedRoute
                exact
                path="/SubjectRating"
                component={SubjectRating}
              />
              <ProtectedRoute
                exact
                path="/SubjectRating/RateMe/:majorID/:subjectID"
                component={SubjectRateMe}
              />
              <ProtectedRoute
                exact
                path="/SubjectRating/:SubjectId"
